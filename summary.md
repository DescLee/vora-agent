...
**Manus Mini** 是一个面向面试展示的本地 AI Agent Runtime 项目，版本号 `0.1.0`。它的核心定位是**展示现代 Agent 工程的系统化落地能力**，而非堆叠功能。
...
manus-mini list --cwd .
manus-mini resume <session_id> --cwd .
```
...
> **Manus Mini V1 是一个小而完整的本地 Agent Runtime，它证明了 Agent 不是一次 LLM 调用，而是围绕会话、目标、工具、状态、权限和三层反馈循环搭建的工程系统。**
